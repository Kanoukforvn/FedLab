...
nohup python3 fednoro_standalone_mnist.py --dataname mnist --warm_up_round 10 --total_client 20 --com_round 100 --level_n_system 0.8 --aggregator fednoro > log_fednoro_cs.out 2>&1 &
...
nohup python3 fednoro_standalone_mnist.py --dataname mnist --warm_up_round 10 --total_client 20 --com_round 100 --level_n_system 0.8 --aggregator fednoro > log_fednoro.out 2>&1 &
...
nohup python3 fednoro_standalone_mnist.py --dataname mnist --warm_up_round 10 --total_client 20 --com_round 100 --level_n_system 0.8 --aggregator fedavg > log_fedavg_cs.out 2>&1 &
...
nohup python3 fednoro_standalone_mnist.py --dataname mnist --warm_up_round 10 --total_client 20 --com_round 100 --level_n_system 0.8 --aggregator fedavg > log_fedavg.out 2>&1 &
