...
nohup python3 fednoro_standalone_mnist.py --dataname mnist --warm_up_round 10 --total_client 20 --com_round 100 --level_n_system 0.4 --aggregator fednoro --noisy_selection True > log_fednoro_cs.out 2>&1 &
...
nohup python3 fednoro_standalone_mnist.py --dataname mnist --warm_up_round 10 --total_client 20 --com_round 100 --level_n_system 0.4 --aggregator fednoro --noisy_selection False > log_fednoro.out 2>&1 &
...
nohup python3 fednoro_standalone_mnist.py --dataname mnist --warm_up_round 10 --total_client 20 --com_round 100 --level_n_system 0.4 --aggregator fedavg --noisy_selection True > log_fedavg_cs.out 2>&1 &
...
nohup python3 fednoro_standalone_mnist.py --dataname mnist --warm_up_round 10 --total_client 20 --com_round 100 --level_n_system 0.4 --aggregator fedavg --noisy_selection False > log_fedavg.out 2>&1 &
...
wait $!
echo "fednoro_standalone_mnist.py with --aggregator fedavg --noisy_selection False has finished"
